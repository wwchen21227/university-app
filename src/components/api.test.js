...
describe('University api', () => {
  it('fetchAllUniversityList', async () => {
    ...
    const mockFetchAllUniversityList = jest
      .spyOn(api, 'fetchAllUniversityList')
  ...
  it('searchUniversity', async () => {
    ...
    const mockSearchUniversity = jest
      .spyOn(api, 'searchUniversity')
      .mockImplementation(() => Promise.resolve(fakeUniversityResponse));
  ...
  it('createSubscriber', async () => {
    ...
    const response = await api.createSubscriber({
